...
function desselecionarPerson() {
  const personSelecionado = document.querySelector(".personagem.select");
  personSelecionado.classList.remove("select");
}

function desselecionarBotao() {
  const botaoSelecionado = document.querySelector(".btn.select");
